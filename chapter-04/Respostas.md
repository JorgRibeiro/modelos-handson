...
### 10 - Por que você usaria cada uma destas opções?

- A regressão Ridge em vez da regressão linear simples (ou seja, sem qualquer regularização).
- A regressão Lasso em vez da regressão Ridge.
- A regressão Elastic Net em vez da regressão Lasso.
